    ...
    function binarySearch(uint16 key) external pure returns (MyStruct memory) {
        if (key == 250) {
            ...
            if (key == 100) {
                ...
                } else if (key < 150) {} else {
                    if (key == 200) {
                        return MyStruct(456, "Value4");
                    } else if (key < 200) {} else {}
                }
            }
        } else {
            if (key == 400) {
                ...
                } else if (key < 300) {} else {
                    if (key == 350) {
                        return MyStruct(890, "Value7");
                    } else if (key < 350) {} else {}
                }
            } else {
                if (key == 450) {
                    return MyStruct(567, "Value9");
                } else if (key < 450) {} else {
                    if (key == 500) {
                        return MyStruct(890, "Value10");
                    } else if (key < 500) {} else {}
                }
            }
        }
    }

    function tree(uint16 _contractIndex) external returns (bytes4, bytes32) {
        if (77 >= _contractIndex) {
            if (101 >= _contractIndex) {
                if (123 >= _contractIndex) {
                    if (202 >= _contractIndex) {
                        if (202 == _contractIndex) {
                            return (
                                0x2304,
            ...
            if (45 >= _contractIndex) {
                if (50 >= _contractIndex) {
                    if (66 >= _contractIndex) {
                        if (66 == _contractIndex) {
                            return (
                                0x6708,
                                0x9012345678901234567890123456789012345678901234567890123456789012
